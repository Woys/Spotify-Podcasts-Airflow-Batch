...
from include.spotify.kaggle import create_kaggle_dataset, run_kaggle_staging_workflow
...
@task
def upload_kaggle_from_s3(s3_key: str, s3_bucket: str, file_name: str):
    ...
    run_kaggle_staging_workflow(
        download_csv, create_kaggle_dataset, logger, DATASET_ID,
        DATASET_TITLE, LICENSE, file_name, "spotify_kaggle_upload_",
    )
...
def spotify_kaggle_upload():
    upload_kaggle_from_s3(S3_KEY, S3_BUCKET, FILE_NAME)
